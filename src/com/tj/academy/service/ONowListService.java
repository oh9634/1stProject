...
public class ONowListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<OrdersDto> list = oDao.nowList(mId, startRow, endRow);
		request.setAttribute("orderNowList", list);
		int totCnt = oDao.getNowTotCnt(mId); // 글갯수
