...
public class OPastListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<OrdersDto> list = oDao.pastList(mId, startRow, endRow);
		request.setAttribute("orderPastList", list);
		int totCnt = oDao.getPastTotCnt(mId); // 글갯수
